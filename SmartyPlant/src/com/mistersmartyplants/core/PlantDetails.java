...
public class PlantDetails extends Activity {
    ...
    void loadImage(String imageUrl, ImageView imgV) {
        class OneShotTask implements Runnable {
            String imageUrl;
            ImageView imgV;
            OneShotTask(String imgUrl, ImageView imgV){
                this.imageUrl = imgUrl; 
                this.imgV = imgV;
            }
            public void run() {
                final Bitmap bMap = lazyLoader.getBitmap(imageUrl, 1000);
        ...
        Thread t = new Thread(new OneShotTask(imageUrl, imgV));
        t.start();
    }
